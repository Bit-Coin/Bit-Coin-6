class Admin::BlogsController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @blog.save
        ...
        format.json { render :show, status: :created, location: admin_blogs_path }
      else
  ...
  def update
    respond_to do |format|
      if @blog.update(blog_params)
        ...
        format.json { render :show, status: :ok, location: admin_blogs_path }
      else
  ...
  private
    ...
    def blog_params
      params.require(:blog).permit(:title, :description, :author, :image, :published_at, :state)
    end
end
