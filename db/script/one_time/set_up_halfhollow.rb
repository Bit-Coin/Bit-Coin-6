...
thename = 'Half Hollow Hills Library' # Name of the co as it should appear in Ripple emails etc.
thedomain = 'hhhlibrary.org' # Co's primary email domain e.g. theboss@thedomain
thestub = 'hhhlibrary' # Stub to be used e.g. thestub.ripplecrew.com

begin
  ActiveRecord::Base.transaction do

    # Create The Boss as a prospect
    theboss = Ripple::OnboardUser.create_prospect('Chris', 'Garland', 'cgarland@hhhlibrary.org', thename)
    ...
    team1_names = [
      [ 'Ellen',       'Druda',     'edruda@hhhlibrary.org' ],
	  [ 'Ruth',       'Hill',     'rhill@hhhlibrary.org' ],
	  [ 'Sheila',       'Blechner',     'sblechner@hhhlibrary.org' ],
    ]
