...
puts "Setting up Bridge The Gap Solutions"

# Company setup details
thename = 'Bridge The Gap' # Name of the co as it should appear in Ripple emails etc.
thedomain = 'btgcorporate.com' # Co's primary email domain e.g. theboss@thedomain
thestub = 'btgcorporate' # Stub to be used e.g. thestub.ripplecrew.com

begin
  ActiveRecord::Base.transaction do

    # Create The Boss as a prospect
    theboss = Ripple::OnboardUser.create_prospect('Irene', 'Chivily Von Toussaint', 'irene@btgcorporate.com', thename)
    ...
    thecompany.set_config(:consultant_mode, false) # members cannot invite new people
    ...
    team1_names = [
      [ 'Nicole',      'Perez',     'n.perez@btgcorporate.com' ],
	  [ 'Chris',       'Capobianco',     'c.capobianco@btgcorporate.com' ],
	  [ 'Sheri',       'Wood',     's.wood@btgcorporate.com' ],
	  [ 'Vinny',       'Scuorzo',     'v.scuorzo@btgcorporate.com' ],
	  [ 'Steven',       'Newman',     's.newman@btgcorporate.com' ],
	  [ 'David',       'Oge',     'd.oge@btgcorporate.com' ],
	  [ 'Sean',       'Thompson',     's.thomson@btgcorporate.com' ],
    ]
  ...
  puts 'Error setting up Bridge The Gap.  Rolled back.'
else
