...
puts "Emery Leadership Group"

# Company setup details
thename = 'Emery Leadership Group' # Name of the co as it should appear in Ripple emails etc.
thedomain = 'emeryleadershipgroup.com' # Co's primary email domain e.g. theboss@thedomain
thestub = 'emeryleadershipgroup' # Stub to be used e.g. thestub.ripplecrew.com

begin
  ActiveRecord::Base.transaction do

    # Create The Boss as a prospect
    theboss = Ripple::OnboardUser.create_prospect('William', 'Pusey', 'bill@emeryleadershipgroup.com', thename)
    ...
    team1_names = [
      [ 'Patrick',       'Veroneau',     'patrick@emeryleadershipgroup.com' ],
    ]
  ...
  puts 'Error setting up Emery Leadership Group.  Rolled back.'
else
