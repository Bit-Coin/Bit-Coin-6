...
puts "Setting up Colliers-2 - Phoenix"

# Company setup details
thename = 'Colliers-2 Phoenix' # Name of the co as it should appear in Ripple emails etc.
thedomain = 'Colliers-2phoenix.com' # Co's primary email domain e.g. theboss@thedomain
thestub = 'Colliers-2phoenix' # Stub to be used e.g. thestub.ripplecrew.com

begin
  ActiveRecord::Base.transaction do

    # Create The Boss as a prospect
    theboss = Ripple::OnboardUser.create_prospect('Bob', 'Mulhern', 'bob_2.mulhern@Colliers-2.com', thename)
    ...
    team1_names = [
      [ 'Bev',       'Jensen',     'bev_2.jensen@Colliers-2.com' ],
    [ 'Nancy',       'Zimmerman',     'nancy_2.zimmerman@Colliers-2.com' ],
    ]
  ...
  puts 'Error setting up Colliers-2 - Phoenix.  Rolled back.'
else
