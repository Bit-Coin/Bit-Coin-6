...
thename = 'EHR Proof of Fix' # Name of the co as it should appear in Ripple emails etc.
thedomain = 'ehrproof.com' # Co's primary email domain e.g. theboss@thedomain
thestub = 'ehrproof' # Stub to be used e.g. thestub.ripplecrew.com

begin
  ActiveRecord::Base.transaction do

    # Create The Boss as a prospect
    theboss = Ripple::OnboardUser.create_prospect('EHR', 'Proof1', 'ehrproof1@gmail.com', thename)
    ...
    team1_names = [
      [ 'EHR',       'Proof2',     'ehrproof2@gmail.com' ],
	  [ 'EHR',       'Proof3',     'ehrproof3@gmail.com' ],
	  [ 'EHR',       'Proof4',     'ehrproof4@gmail.com' ],
	  [ 'EHR',       'Proof5',     'ehrproof5@gmail.com' ],
	  [ 'EHR',       'Proof6',     'ehrproof6@gmail.com' ],
	  [ 'EHR',       'Proof7',     'ehrproof7@gmail.com' ],
	  [ 'EHR',       'Proof8',     'ehrproof8@gmail.com' ],
	  [ 'EHR',       'Proof9',     'ehrproof9@gmail.com' ],
	  [ 'EHR',       'Proof10',     'ehrproof10@gmail.com' ],
    ]
